    ...
    <div class="jumbotron">
        <div class="text-center">
            ​<div class="owl-carousel">
                ...
                <img src="{{asset('assets/hp.png')}}" alt="Responsive image" class="img-fluid" alt="" width="25%">
                <img src="{{asset('assets/hp2.png')}}" alt="Responsive image" class="img-fluid" alt="" width="25%">
                <img src="{{asset('assets/asus.png')}}" alt="Responsive image" class="img-fluid" alt="" width="25%">
                <img src="{{asset('assets/tuf.png')}}" alt="Responsive image" class="img-fluid" alt="" width="25%">
                <img src="{{asset('assets/gaming.png')}}" alt="Responsive image" class="img-fluid" alt="" width="25%">
                <img src="{{asset('assets/acer.png')}}" alt="Responsive image" class="img-fluid" alt="" width="25%">
            </div>
        ...
        <center class="mt-5">
            <a class="rekomendasi-btn font-weight-bold" href="{{url('/profile')}}">SISTEM REKOMENDASI
                <i class="icon-arrow-right ml-2"></i></a>
        </center>
        {{-- <a href="#" class="btn btn-bubble">Bubble Button</a> --}}
    </div>
    @php
        // $command = escapeshellcmd('python-extract-from-wsm.ipynb');
